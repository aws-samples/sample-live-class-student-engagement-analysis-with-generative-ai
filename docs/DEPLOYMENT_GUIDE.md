...
Step 3. Enable Amazon Bedrock Model access.
 ...
 b. Click on **Get Started** and then click on **Request access model** from the bottom of left pannel.
  ...
  ![Fig 1.1](/live-class-student-attentiveness-and-engagement-analysis/asset/bedrock/image1.png)

  ![Fig 1.2](/live-class-student-attentiveness-and-engagement-analysis/asset/bedrock/image2.png)

 c. Enable Claude 3 sonet Model and click on **Next**.

  ![Fig 1.3](/live-class-student-attentiveness-and-engagement-analysis/asset/bedrock/image3.png)

 d. Click on **Submit** button to save the changes.

  ![Fig 1.4](/live-class-student-attentiveness-and-engagement-analysis/asset/bedrock/image4.png)
...
`git clone git@ssh.gitlab.aws.dev:nehanejh/live-class-student-attentiveness-and-engagement-analysis.git`
...
Step 3. Click on **create stack**  button and select **with new resource(standard)** .
  ...
  ![Fig 2](/live-class-student-attentiveness-and-engagement-analysis/asset/cloudformation-stack/image1.png)
...
step 4. Then select **Choose an existing template** under prepare template. Under template source select **upload a template file** and then choose file **main-template.yaml** from the extreacted zip-file and click on **Next**.
  ...
  ![Fig 3](/live-class-student-attentiveness-and-engagement-analysis/asset/cloudformation-stack/image2.png)
...
Step 5. Provide the stack details:
  ...
  ![Fig 4](/live-class-student-attentiveness-and-engagement-analysis/asset/cloudformation-stack/image3.png)
...
Step 6. Leave everything as default , and click on **Next**
  ...
  ![Fig 5](/live-class-student-attentiveness-and-engagement-analysis/asset/cloudformation-stack/image4.png)
...
**I acknowledge that AWS CloudFormation might create IAM resources.**
  ...
  ![Fig 6](/live-class-student-attentiveness-and-engagement-analysis/asset/cloudformation-stack/image5.png)
...
![Fig 7.1](/live-class-student-attentiveness-and-engagement-analysis/asset/lambda-fun/image1.png)

Click on **Upload** from the top and select .zip file.

![Fig 7.2](/live-class-student-attentiveness-and-engagement-analysis/asset/lambda-fun/image2.png)
...
![Fig 8.1](/live-class-student-attentiveness-and-engagement-analysis/asset/demo/image1.png)

Step-2. Click on the Outputs tab, scroll down, and find the frontendAppBaseUrl. Use this URL to open the login page.

![Fig 8.2](/live-class-student-attentiveness-and-engagement-analysis/asset/demo/image2.png)

Step-3. Create a user account and login to access the home screen.

![Fig 8.3](/live-class-student-attentiveness-and-engagement-analysis/asset/demo/image3.png)

![Fig 8.4](/live-class-student-attentiveness-and-engagement-analysis/asset/demo/image4.png)

![Fig 8.5](/live-class-student-attentiveness-and-engagement-analysis/asset/demo/image5.png)
...
![Fig 8.6](/live-class-student-attentiveness-and-engagement-analysis/asset/recording-config/image1.png)
...
![Fig 8.7](/live-class-student-attentiveness-and-engagement-analysis/asset/recording-config/image2.png)
...
![Fig 8.8](/live-class-student-attentiveness-and-engagement-analysis/asset/recording-config/image3.png)

Step-8. Select Storage Option: Under Storage, choose Select an **existing Amazon S3 bucket**.

![Fig 8.9](/live-class-student-attentiveness-and-engagement-analysis/asset/recording-config/image4.png)
...
![Fig 8.11](/live-class-student-attentiveness-and-engagement-analysis/asset/recording-config/image7.png)

Step-11. **Enable automatic recording**, select the created recording configuration, and click **Save Changes.**

![Fig 8.12](/live-class-student-attentiveness-and-engagement-analysis/asset/recording-config/image8.png)
