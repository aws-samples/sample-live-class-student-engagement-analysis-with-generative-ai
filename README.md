...
For the demo, we can use another existing Amazon IVS based solution Amazon IVS UGC platform—a reference demo application that allows live streaming, user authentication, live chat, and more. Follow GitHub README.mdfor more details including steps for installing it in your AWS account.
